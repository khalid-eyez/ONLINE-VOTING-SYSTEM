...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['description'], 'string'],
            [['price'], 'number'],
            [['status', 'created_at', 'created_by', 'updated_by'], 'integer'],
            [['name'], 'string', 'max' => 255],
     ...
     *
     * @return \yii\db\ActiveQuery|\app\models\query\CartItemsQuery
     */
     ...
     *
     * @return \yii\db\ActiveQuery|\app\models\query\OrderItemsQuery
     */
